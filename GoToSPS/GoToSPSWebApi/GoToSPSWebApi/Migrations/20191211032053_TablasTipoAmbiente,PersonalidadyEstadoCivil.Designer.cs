...
namespace GoToSPSWebApi.Migrations
{
    ...
    [Migration("20191211032053_TablasTipoAmbiente,PersonalidadyEstadoCivil")]
    partial class TablasTipoAmbientePersonalidadyEstadoCivil
    {
            ...
            modelBuilder.Entity("GoToSPSWebApi.Models.ItinerarioEncabezado", b =>
                {
                    ...
                    b.HasOne("GoToSPSWebApi.Models.Usuario", "Usuario")
                        .WithMany("ItinerarioEncabezados")
